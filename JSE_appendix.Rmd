...
# Theoretical example: homogeneous controls{#sec:thh}

Analyses rely on the _dbmss_ [@Marcon2014] package for R [@R].

This example completes that of the main text, detailed in section \@ref(sec:thnonh).
...
# Theoretical example: non-homogeneuous controls{#sec:thnonh}
